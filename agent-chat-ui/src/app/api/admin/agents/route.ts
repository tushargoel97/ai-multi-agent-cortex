...
/** Normalize a user-supplied agent name into a safe, stable identifier. */
...
/** All agents (built-in + custom) with their effective tools, plus the list
 * of grantable tools and packaged defaults, for the Agents panel. */
...
/** Create a custom agent (auto-routes via the intent router by description). */
